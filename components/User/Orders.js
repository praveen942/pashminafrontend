...
export default function Example({setReturnProduct}) {
  return (
    <div className="bg-white">
      <div className="pb-16 sm:py-24">
                ...
                >
                  ...
                  <div className="flex items-center p-4 border-b border-gray-200 sm:p-6 sm:grid sm:grid-cols-4 sm:gap-x-6">
                    ...
                    <div className="hidden lg:col-span-2 lg:flex lg:items-center lg:justify-end lg:space-x-4">
                      <a
                        href={order.href}
                        className="flex items-center justify-center bg-white py-2 px-2.5 border border-maroon rounded-md shadow-sm text-sm font-medium text-maroon hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                      >
                    ...
                    {order.products.map((product) => (
                      <li key={product.id} className="p-4 sm:p-6">
                        <div className="flex items-center sm:items-start">
                          <div className="flex-shrink-0 relative w-20 h-20 bg-gray-200 rounded-lg overflow-hidden sm:w-40 sm:h-40">
                            <Image
                        ...
                        <div className="mt-6 sm:flex sm:justify-between">
                          ...
                          <div className="flex-1 flex justify-center cursor-pointer"onClick={()=>setReturnProduct(true)}>
                              <div
                                className="text-maroon whitespace-nowrap  "
                              >
                                Return
                              </div>
                            </div>
                            <div className="flex-1 flex pl-4 justify-center ">
                              <a
                                href={product.href}
                                className="text-maroon whitespace-nowrap  "
                              >
